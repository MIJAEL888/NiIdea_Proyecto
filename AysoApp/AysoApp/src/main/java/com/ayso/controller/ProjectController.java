 ...
 */
@Controller
@SessionAttributes("formProject")
public class ProjectController {
    
    @ModelAttribute("formProject")
   ...
   public String newProject(@ModelAttribute(value="formProject") Project project, Model model, HttpSession session) {
...
//       model.addAttribute("listClient", lc);
       ...
       model.addAttribute("formProject", project);
